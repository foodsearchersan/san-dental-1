  ...
  return (
    <div>
      <div className='on6_img_cont'>
        <img data-aos="Zoom-out-up" src={Picture6} />
      ...
      <div className='on6_div33_cont'>
        <div className='on6_div3_cont'>
          ...
          <div className='on6_div3_main_cont on4_2_on6_div3_main_cont'>
            <div className='on6_div3_main_cont_2 on4_on6_div3_main_cont_2 on4_on6_div3_main_cont_2 on4_on6_div3_main_cont_2'>
              <ul>
                ...
                <li data-aos="fade-up">
                  <TiTick className="on6_tick_icon" />
                  <div>
                    <p>Patient is educated about what to expect in the All-On-4 procedure. </p>
                  </div>
                </li>
                <li data-aos="fade-up">
                  <TiTick className="on6_tick_icon" />
                ...
                <li data-aos="fade-up">
                  <TiTick className="on6_tick_icon" />
                  <div>
                    <p>After six to seven months, placing a new bridge is recommended. Acrylic, ceramic, titanium with acrylic or titanium with ceramic are some of the bridge options advised.</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <div className='on6_div33_cont on4_on6_div33_cont on6_footer '>
        <div className='on6_div3_cont'>
          ...
          <div className='on6_div3_main_cont'>
            <div className='on6_div3_main_cont_2 on4_on6_div3_main_cont_2 '>
              <ul>
                <li data-aos="fade-up">
                  <TiTick className="on6_tick_icon" />
